...
public class SettingFragment extends BaseFragment {
    ...
    private void handleMenuList(){
        ...
        mMenuList.addView(new MenuListItem(getContext(), R.string.share_app,R.drawable.setting_share_app, AboutAppActivity.class));
        mMenuList.addView(new MenuListItem(getContext(), R.string.feedback,R.drawable.setting_feedback, AboutAppActivity.class));
