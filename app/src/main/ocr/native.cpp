...
Java_com_scu_guanyan_utils_ORC_OCRPredictorNative_init(
...
Java_com_scu_guanyan_utils_ORC_OCRPredictorNative_forward(
...
Java_com_scu_guanyan_utils_ORC_OCRPredictorNative_release(
