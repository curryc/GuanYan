...
public class MainActivity extends AppCompatActivity {
    ...
    public String language = GeneratorConstants.CN_CSL;
    ...
    private String faceFormat = "FaceType is: %d %s";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // init SignGenerator
        generatorSetting = new GeneratorSetting().setLanguage(language);
    ...
    private void setBitMapView(){
        if (!avatarPaint.frameQueue.isEmpty() &&isPlay){
            ...
            faceTypeView.setText(String.format(faceFormat,frameDataPair.second,faceTypes[frameDataPair.second]));
        }
    }
