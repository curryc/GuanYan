...
//    private Handler handler = new Handler();
    private ExecutorService anim = Executors.newSingleThreadExecutor();
    public AvatarPaint() {
        anim.execute(runnable);
//        handler.post(runnable);
    ...
    Runnable runnable = new Runnable() {
        @Override
        public void run() {
            System.out.println(frameDataQueue.size());
...
//            anim.postDelayed(runnable, 1000/FPS_30); // FPS30 Delayed rendering to prevent memory overflow
        }
    };
